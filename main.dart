...
class LoginScreenState extends State<LoginScreen> {
  ...
  Future<User> fetchUser(http.Client client) async {
    print('hello');
    print('fname is: $fName should be null'); // Should be null here
    print('lname is: $lName should be null'); // Should be null here
    ...
    if (response.statusCode == 200) {
      ...
      if (curUser.email_address == email && curUser.password == pass) {
        ...
        print('globals.userid is: ' + globals.userID.toString());
        final response = await http.get(
